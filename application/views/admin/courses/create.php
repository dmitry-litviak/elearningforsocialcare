<form class="form-actions" action="<?php echo URL::site('admin/courses/create') ?>" method="POST">
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <textarea class="validate[required]" placeholder="Description" name="description"></textarea>
            </div>
        </div>
        <hr>
        <div class="control-group">
            ...
            <div class="controls">
                <textarea name="material" class="textarea validate[required]" placeholder="Enter text ..." style="width: 810px; height: 200px"></textarea>
            </div>
        </div>
        <div class="control-group">
